...
const Modal = ({
	...
	return (
		...
		>
			<div className="w-[50vw] max-h-[80vh] xl:w-[25vw] bg-gray-900 rounded-xl text-center flex flex-col gap-y-4 p-4 justify-center relative text-white shadow-lg overflow-auto">
